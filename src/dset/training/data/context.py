...
from dset.training.data.operations import PatchingDataIndex
...
class PatchingUpdate:
    ...
    def __init__(
        self,
        iterator: "PatchingDataIndex | DSETTrainer | DataStep",
        ...
        Args:
            iterator (PatchingDataIndex | DSETTrainer): Iterator to update
