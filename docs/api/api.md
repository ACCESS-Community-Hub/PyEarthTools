...
|     [Bundled Models](bundled_models/bundled_index.md) | [Model How-To](models/models_how_to.md)              | Maintained versions of specific, bundled models which can be easily trained and run |
