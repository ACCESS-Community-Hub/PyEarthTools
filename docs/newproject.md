...
**Step Two:** Load and visualise your data. Read [the data API how-to](/api/data/data_how_to.md) for more information regarding fetching and adding data.
...
**Step Four:** Train an initial model to establish a baseline. There is currently one published architecture bundled in the framework and several tutorials demonstrating how to code a new model from scratch. Read the [models how-to guide](api/models/models_how_to.md) for more information.
