...
class Structured(ArchiveIndex):
    ...
    def _parse_glob(self, time: EDITDatetime, variable: str) -> Path:
        ...
        dir_path = Path(getattr(self, "root_directory", self.ROOT_DIRECTORIES[self.__class__.__name__])) / self.dir
...
class ExampleStructured(Structured):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(variables, transforms=transforms, frequency=frequency, nature=nature, domain=domain)
