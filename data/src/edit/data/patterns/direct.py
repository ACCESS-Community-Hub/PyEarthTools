...
from edit.data.patterns import PatternIndex, PatternTimeIndex, PatternVariableAware, PatternForecastIndex
        ...
        **kwargs,
        ...
        Args:
            ...
            extension (str, optional):
                File extension to load. Defaults to 'nc'
...
class Direct(_Direct):
    ...
    def to_temporal(self, data_interval: tuple[int, str] | int) -> TemporalDirect:
        ...
        return TemporalDirect(data_interval=data_interval, **self.catalog.prefilled_kwargs)
...
def DirectFactory(*args: Any, temporal: bool = False, variable: bool = False, forecast: bool = False, **kwargs) -> _Direct:
