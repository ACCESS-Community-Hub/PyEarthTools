...
from edit.data.transform import interpolation as interp
...
def SpatialInterpolation(
    ...
    **kwargs,
    ...
    Uses [transform.interpolation][edit.data.transform.interpolation.InterpolateTransform], thus all kwargs passed there
    ...
    Args:
        ...
        **kwargs (optional): Extra kwargs passed to [transform.interpolation][edit.data.transform.interpolation.InterpolateTransform.like]
...
def TemporalInterpolation(
    ...
    **kwargs,
    ...
    Uses [transform.Aggregation][edit.data.transform.aggregation.AggregateTransform.over], thus all kwargs passed there
    ...
    Args:
        *datasets (xr.Dataset):
        ...
        aggregation_function (Callable | str, optional):
            Aggregation function to use. Uses [transform.Aggregation][edit.data.transform.aggregation.AggregateTransform.over].
            Defaults to "mean".
        merge (bool, optional):
            Whether to merge datasets together. Defaults to True.
        include_reference (bool, optional):
    ...
    last_index = None
    aggregation = transform.aggregation.over(aggregation_function, dimension="time", **kwargs)
