...
@click.option("--blacklisted", "-b", type=str, multiple=True, default=[], help="Folder names to exclude.")
@click.option("--save", type=click.Path(), default=None, help="Save location, if not given print out.")
@click.option("--verbose/--quiet", type=bool, default=False)
